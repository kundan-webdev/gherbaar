...
import { getMyInvoicePayment } from '../../features/tenantPortal/tenantPortalApi.js';
...
export default function TenantReceiptDetailPage() {
  ...
  const { data: payment, isLoading } = useQuery({
    queryKey: ['me', 'invoices', invoiceId, 'payments', paymentId],
    queryFn: () => getMyInvoicePayment(invoiceId, paymentId),
  });
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <Link className="btn secondary" to={`/tenant/invoices/${invoiceId}`}>
